...
namespace ManipulatorMod.Modules
{
    internal static class Skills
    {
        ...
        internal static void CreateSkillFamilies(GameObject targetPrefab)
        {
            ...
            {
                ManipulatorPlugin.DestroyImmediate(obj);
            }

            SkillLocator skillLocator = targetPrefab.GetComponent<SkillLocator>();
            ManipulatorElementController elementController = targetPrefab.AddComponent<ManipulatorElementController>();
            ...
            elementController.elementSkill._skillFamily = elementFamily;
        ...
        internal static void AddElementSkill(GameObject targetPrefab, SkillDef skillDef)
        {
            ManipulatorElementController elementController = targetPrefab.GetComponent<ManipulatorElementController>();

            SkillFamily skillFamily = elementController.elementSkill.skillFamily;
        ...
        internal static void AddElementSkills(GameObject targetPrefab, params SkillDef[] skillDefs)
        {
            foreach (SkillDef i in skillDefs)
            {
                AddElementSkill(targetPrefab, i);
            }
        }
        ...
        internal static SkillDefElement CreateElementSkillDef(ElementSkillDefInfo skillDefElementInfo)
        {
            ...
            skillDef.skillName = skillDefElementInfo.skillName;
            skillDef.skillNameToken = skillDefElementInfo.skillNameToken;
            skillDef.skillDescriptionToken = skillDefElementInfo.skillDescriptionToken;
            skillDef.defIcon = skillDefElementInfo.defIcon;
            skillDef.icon = skillDef.defIcon;
            skillDef.fireIcon = skillDefElementInfo.fireIcon;
            skillDef.lightningIcon = skillDefElementInfo.lightningIcon;
            skillDef.iceIcon = skillDefElementInfo.iceIcon;

            skillDef.activationState = skillDefElementInfo.activationState;
            skillDef.activationStateMachineName = skillDefElementInfo.activationStateMachineName;
            skillDef.baseMaxStock = skillDefElementInfo.baseMaxStock;
            skillDef.baseRechargeInterval = skillDefElementInfo.baseRechargeInterval;
            skillDef.beginSkillCooldownOnSkillEnd = skillDefElementInfo.beginSkillCooldownOnSkillEnd;
            skillDef.canceledFromSprinting = skillDefElementInfo.canceledFromSprinting;
            skillDef.forceSprintDuringState = skillDefElementInfo.forceSprintDuringState;
            skillDef.fullRestockOnAssign = skillDefElementInfo.fullRestockOnAssign;
            skillDef.interruptPriority = skillDefElementInfo.interruptPriority;
            skillDef.resetCooldownTimerOnUse = skillDefElementInfo.resetCooldownTimerOnUse;
            skillDef.isCombatSkill = skillDefElementInfo.isCombatSkill;
            skillDef.mustKeyPress = skillDefElementInfo.mustKeyPress;
            skillDef.cancelSprintingOnActivation = skillDefElementInfo.cancelSprintingOnActivation;
            skillDef.rechargeStock = skillDefElementInfo.rechargeStock;
            skillDef.requiredStock = skillDefElementInfo.requiredStock;
            skillDef.stockToConsume = skillDefElementInfo.stockToConsume;

            skillDef.keywordTokens = skillDefElementInfo.keywordTokens;
        ...
        {
            ManipulatorTrackingSkillDef skillDef = ScriptableObject.CreateInstance<ManipulatorTrackingSkillDef>();
        ...
        /*internal static SkillDef[] CreateElementVariations(SkillDef inDef, string iconName)
        {
            SkillDef tempDefFire = inDef;
            tempDefFire.icon = Modules.Assets.mainAssetBundle.LoadAsset<Sprite>(iconName + "Fire");
            SkillDef tempDefLightning = inDef;
            tempDefLightning.icon = Modules.Assets.mainAssetBundle.LoadAsset<Sprite>(iconName + "Fire");
            SkillDef tempDefIce = inDef;
            tempDefIce.icon = Modules.Assets.mainAssetBundle.LoadAsset<Sprite>(iconName + "Fire");
            SkillDef[] newSkills = {tempDefFire, tempDefLightning, tempDefIce };
            return newSkills;
        }*/
    }
}
