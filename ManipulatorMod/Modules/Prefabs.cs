...
namespace ManipulatorMod.Modules
{
    ...
    internal static class Prefabs
    {
        ...
        {
            string fullNameString = ManipulatorPlugin.developerPrefix + "_" + namePrefix + "_BODY_NAME";
            string fullDescString = ManipulatorPlugin.developerPrefix + "_" + namePrefix + "_BODY_DESCRIPTION";
            string fullOutroString = ManipulatorPlugin.developerPrefix + "_" + namePrefix + "_BODY_OUTRO_FLAVOR";
            string fullFailureString = ManipulatorPlugin.developerPrefix + "_" + namePrefix + "_BODY_OUTRO_FAILURE";
        ...
        {
            ManipulatorPlugin.DestroyImmediate(main.transform.Find("ModelBase").gameObject);
            ManipulatorPlugin.DestroyImmediate(main.transform.Find("CameraPivot").gameObject);
            ManipulatorPlugin.DestroyImmediate(main.transform.Find("AimOrigin").gameObject);
        ...
        private static void SetupCameraTargetParams(GameObject prefab)
        {
            ...
            cameraTargetParams.cameraParams.standardLocalCameraPos = StatValues.localCameraPos;
            cameraTargetParams.cameraPivotTransform = prefab.transform.Find("ModelBase").Find("CameraPivot");
            cameraTargetParams.cameraPivotTransform.localPosition = StatValues.localCameraPivot;
