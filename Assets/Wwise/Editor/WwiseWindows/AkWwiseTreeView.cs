...
public class AkWwiseTreeView : TreeViewControl
{
	...
	private static System.Collections.Generic.Dictionary<WwiseObjectType, MonoScript> DragDropMonoScriptMap;
	...
	private TreeViewItem AddPathToTreeItem(TreeViewItem item,
	...
	/// </summary>
	private void AddHandlerEvents(TreeViewItem item)
	{
	...
	///     Wwise logos
	/// </summary>
	private Texture2D m_textureWwiseAuxBusIcon;

	private Texture2D m_textureWwiseBusIcon;
	private Texture2D m_textureWwiseEventIcon;
	private Texture2D m_textureWwiseFolderIcon;
	private Texture2D m_textureWwisePhysicalFolderIcon;
	private Texture2D m_textureWwiseProjectIcon;
	private Texture2D m_textureWwiseSoundbankIcon;
	private Texture2D m_textureWwiseStateIcon;
	private Texture2D m_textureWwiseStateGroupIcon;
	private Texture2D m_textureWwiseSwitchIcon;
	private Texture2D m_textureWwiseSwitchGroupIcon;
	private Texture2D m_textureWwiseWorkUnitIcon;
	...
	public override void AssignDefaults()
	{
		...
		{
			var InspectorSkin =
                Object.Instantiate(EditorGUIUtility.GetBuiltinSkin(EditorSkin.Inspector));
		...
		{
			DragDropMonoScriptMap = new System.Collections.Generic.Dictionary<WwiseObjectType, MonoScript>();
	...
	public override void DisplayTreeView(DisplayTypes displayType)
	{
		...
		else
		{
            ...
            GUILayout.Label(AkUtilities.GetFullPath(Application.dataPath,
				WwiseSetupWizard.Settings.WwiseProjectPath));
            GUILayout.Label("Wwise Picker will not be usable.");
		}
	}

	private bool FilterTreeview(TreeViewItem in_item)
	{
	...
	private void RestoreExpansionStatus(TreeViewItem in_item, ref string in_path)
	{
	...
	public TreeViewItem GetItemByType(WwiseObjectType type)
	{
		return GetItemByType(RootItem, type);
	}

	public TreeViewItem GetItemByType(TreeViewItem in_item, WwiseObjectType type)
	{
