...
{
   internal class ManipulatorUnlock : UnlockableCreator.ManipulatorAchievement
    {
        ...
        public override UnlockableDef UnlockableDef => Modules.Assets.mainAssetBundle.LoadAsset<UnlockableDef>("Characters.Manipulator");
        ...
        {
            UnlockableCreator.AddUnlockable<ManipulatorUnlock>(false);
        }
