...
{
    internal class ManipulatorJump : UnlockableCreator.ManipulatorAchievement
    {
        ...
        public override UnlockableDef UnlockableDef => Modules.Assets.mainAssetBundle.LoadAsset<UnlockableDef>("Skills.Manipulator.VentedRise");
        ...
        {
            UnlockableCreator.AddUnlockable<ManipulatorJump>(true);
        }
