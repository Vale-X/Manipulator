...
{
    public class BaseMeleeAttack : BaseSkillElement
    {
        [SerializeField]
        ...
        protected float baseEarlyExitTime = 0.5f;
        ...
        protected virtual void SetNextState()
        {
            ...
            var obj = (BaseMeleeAttack)Activator.CreateInstance(this.activatorSkillSlot.activationState.GetType());
